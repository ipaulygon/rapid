...
@section('content')	
	...
	<hr><br>
	<button class="ui primary button" name="modalNew" onclick="modal(this.name)"><i class="plus icon"></i>New Variance</button>
	<br><br>
			...
			@foreach($variance as $variance)
				@if($variance->varianceIsActive==1)
					<tr>
						...
						<td>
							<button class="ui primary basic circular icon button" data-tooltip="Update Record" data-inverted="" name="edit{{ $variance->varianceId }}" onclick="modal(this.name)"><i class="write icon"></i></button>
										...
										<div class="ui form">
					        				...
					        				<div class="inline fields">
					        					...
					        					<div class="six wide field">
					        						<input maxlength="140" type="text" name="editVarianceSize" value="{{ $variance->varianceSize }}" placeholder="Variance">
					        					</div>
					        					<div class="two wide field">
					        				...
					        				<div class="inline fields">
					        					...
					        					<div class="fourteen wide field">
					        						<textarea maxlength="140" type="text" name="editVarianceDesc" placeholder="Description">{{ $variance->varianceDesc }}</textarea>
					        					</div>
					        				</div>
										</div>
									</div>
				...
				<div class="ui form">
					{!! Form::open(['action' => 'VarianceController@create']) !!}
	    				...
	    				<div class="inline fields">
	    					...
	    					<div class="six wide field">
	    						<input maxlength="140" type="text" name="varianceSize" placeholder="Variance" value="{{old('varianceSize')}}">
	    					</div>
	    					<div class="two wide field">
	    						<label>Unit<span>*</span></label>
	    					</div>
	    				...
	    				<div class="inline fields">
	    					...
	    					<div class="fourteen wide field">
	    						<textarea maxlength="140" type="text" name="varianceDesc" placeholder="Description">{{old('varianceDesc')}}</textarea>
	    					</div>
	    				</div>
	    				<div class="actions">
	    					<i>Note: All with <span>(*)</span> are required fields</i>
