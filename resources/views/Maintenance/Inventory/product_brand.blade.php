...
@section('content')	
	...
	<hr><br>
	<button class="ui positive button" name="modalCreate" onclick="modal(this.name)"><i class="plus icon"></i>Add Brand</button>
	<br><br>
			...
			@foreach($brand as $brand)
				@if($brand->brandIsActive==1)
					<tr>
						...
						<td>
							<button class="ui green basic circular icon button" data-tooltip="Update Data" data-inverted="" name="edit{{ $brand->brandId }}" onclick="modal(this.name)"><i class="write icon"></i></button>
							<button class="ui red basic circular icon button" data-tooltip="Deactivate Data" data-inverted="" name="del{{ $brand->brandId }}" onclick="modal(this.name)"><i class="trash icon"></i></button>
						</td>
						<!--Modal for Update-->
	...
	<div class="ui small modal" id="modalCreate">
		<div class="header">Create Brand</div>
		<div class="content">
			<div class="description">
				<div class="ui form">
