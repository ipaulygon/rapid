			...
			@foreach($brand as $brand)
				@if($brand->brandIsActive==1)
					<tr>
						...
						<td>
							<button class="ui green basic button" name="edit{{ $brand->brandId }}" onclick="modal(this.name)"><i class="write icon"></i>Edit</button>
							<button class="ui red basic button" name="del{{ $brand->brandId }}" onclick="modal(this.name)"><i class="trash icon"></i>Delete</button>
						</td>
						<!--Modal for Edit-->
