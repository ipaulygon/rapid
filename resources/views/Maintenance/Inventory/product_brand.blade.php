										...
										<div class="ui form">
					        				...
					        				<div class="inline fields">
					        					...
					        					<div class="fourteen wide field">
					        						<input maxlength="140" type="text" name="editBrandName" value="{{ $brand->brandName }}" placeholder="Brand">
					        					</div>
					        				</div>
					        				<div class="inline fields">
					        					<div class="two wide field">
					        					...
					        					<div class="fourteen wide field">
					        						<textarea maxlength="140" type="text" name="editBrandDesc" placeholder="Description">{{ $brand->brandDesc }}</textarea>
					        					</div>
					        				</div>
										</div>
									</div>
				...
				<div class="ui form">
					{!! Form::open(['action' => 'BrandController@create']) !!}
	    				...
	    				<div class="inline fields">
	    					...
	    					<div class="fourteen wide field">
	    						<input maxlength="140" type="text" name="brandName" placeholder="Brand" value="{{old('brandName')}}">
	    					</div>
	    				</div>
	    				<div class="inline fields">
	    					<div class="two wide field">
	    					...
	    					<div class="fourteen wide field">
	    						<textarea maxlength="140" type="text" name="brandDesc" placeholder="Description">{{old('brandDesc')}}</textarea>
	    					</div>
	    				</div>
	    				<div class="actions">
	    					<i>Note: All with <span>*</span> are required fields</i>
