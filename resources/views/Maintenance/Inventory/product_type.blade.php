...
@section('content')	
	...
	<hr><br>
	<button class="ui positive button" name="modalAdd" onclick="modal(this.name)"><i class="plus icon"></i>Add Product Type</button>
	<br><br>
	...
	<div class="ui small modal" id="modalAdd">
		<div class="header">Add Product Type</div>
		<div class="content">
			<div class="description">
				<div class="ui form">
