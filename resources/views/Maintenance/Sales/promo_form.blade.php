			...
			<div class="inline fields">
				...
				<div class="six wide field">
					<div class="ui labeled input">
						...
						<input style="text-align:right" type="text" id="packageCost" name="promoCost" value="{{old('promoCost')}}" onkeypress="return validated(event,this.id)" data-content="Only numerical values are allowed" maxlength="8" placeholder="Price">
					</div>
				</div>
			</div>
			<div class="inline fields">
