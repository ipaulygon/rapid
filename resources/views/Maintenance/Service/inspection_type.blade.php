										...
										<div class="ui form">
					        				...
					        				<div class="inline fields">
					        					...
					        					<div class="fourteen wide field">
					        						<input maxlength="140" type="text" name="editInspectTypeName" value="{{ $inspectType->inspectTypeName }}" placeholder="Inspect Type">
					        					</div>
					        				</div>
					        				<div class="inline fields">
					        					<div class="two wide field">
					        					...
					        					<div class="fourteen wide field">
					        						<textarea maxlength="140" type="text" name="editInspectTypeDesc" placeholder="Description">{{ $inspectType->inspectTypeDesc }}</textarea>
					        					</div>
					        				</div>
										</div>
									</div>
				...
				<div class="ui form">
					{!! Form::open(['action' => 'InspectTypeController@create']) !!}
	    				...
	    				<div class="inline fields">
	    					...
	    					<div class="fourteen wide field">
	    						<input maxlength="140" type="text" name="inspectTypeName" placeholder="Inspection Type" value="{{old('inspectTypeName')}}">
	    					</div>
	    				</div>
	    				<div class="inline fields">
	    					<div class="two wide field">
	    					...
	    					<div class="fourteen wide field">
	    						<textarea maxlength="140" type="text" name="inspectTypeDesc" placeholder="Description">{{old('inspectTypeDesc')}}</textarea>
	    					</div>
	    				</div>
	    				<div class="actions">
	    					<i>Note: All with <span>(*)</span> are required fields</i>
