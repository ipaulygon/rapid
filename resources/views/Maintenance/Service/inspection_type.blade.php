...
@section('content')	
	...
	<hr><br>
	<button class="ui positive button" name="modalCreateType" onclick="modal(this.name)"><i class="plus icon"></i>Add Inspection Type</button>
	<br><br>
			...
			@foreach($inspect_type as $inspectType)
				@if($inspectType->inspectTypeIsActive==1)
					<tr>
						...
						<td>
							<button class="ui green basic circular icon button" data-tooltip="Update Data" data-inverted="" name="edit{{ $inspectType->inspectTypeId }}" onclick="modal(this.name)"><i class="write icon"></i></button>
							<button class="ui red basic circular icon button" data-tooltip="Deactivate Data" data-inverted="" name="del{{ $inspectType->inspectTypeId }}" onclick="modal(this.name)"><i class="trash icon"></i></button>
						</td>
						<!--Modal for Update-->
	...
	<!--Create Modal-->
	<div class="ui small modal" id="modalCreateType">
		<div class="header">Create Inspection Type</div>
		<div class="content">
			<div class="description">
				<div class="ui form">
