...
@section('content')	
	...
	<hr><br>
	<button class="ui primary button" name="modalNew" onclick="modal(this.name)"><i class="plus icon"></i>New Service Category</button>
	<br><br>
			...
			@foreach($service_category as $category)
				@if($category->categoryIsActive==1)
					<tr>
						...
						<td>
							<button class="ui primary basic circular icon button" data-tooltip="Update Record" data-inverted="" name="edit{{ $category->categoryId }}" onclick="modal(this.name)"><i class="write icon"></i></button>
										...
										<div class="ui form">
					        				...
					        				<div class="inline fields">
					        					...
					        					<div class="fourteen wide field">
					        						<input maxlength="140" type="text" name="editCategoryName" value="{{ $category->categoryName }}" placeholder="Service Category">
					        					</div>
					        				</div>
					        				<div class="inline fields">
					        					<div class="two wide field">
					        					...
					        					<div class="fourteen wide field">
					        						<textarea maxlength="140" type="text" name="editCategoryDesc" placeholder="Description">{{ $category->categoryDesc }}</textarea>
					        					</div>
					        				</div>
										</div>
									</div>
				...
				<div class="ui form">
					{!! Form::open(['action' => 'ServiceCategoryController@create']) !!}
	    				...
	    				<div class="inline fields">
	    					...
	    					<div class="fourteen wide field">
	    						<input maxlength="140" type="text" name="categoryName" placeholder="Service Category" value="{{old('categoryName')}}">
	    					</div>
	    				</div>
	    				<div class="inline fields">
	    					<div class="two wide field">
	    					...
	    					<div class="fourteen wide field">
	    						<textarea maxlength="140" type="text" name="categoryDesc" placeholder="Description">{{old('categoryDesc')}}</textarea>
	    					</div>
	    				</div>
	    				<div class="actions">
	    					<i>Note: All with <span>(*)</span> are required fields</i>
